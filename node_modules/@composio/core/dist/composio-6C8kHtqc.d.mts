...
declare class Tools<TToolCollection, TTool, TProvider extends BaseComposioProvider<TToolCollection, TTool, unknown>> {
   ...
   */
  private clientWithoutRetriesCache?;
   ...
   */
  private get clientWithoutRetries();
  /**
...
declare const AuthConfigListParamsSchema: z$1.ZodObject<{
  ...
  showDisabled: z$1.ZodOptional<z$1.ZodBoolean>;
...
declare const SetWebhookSubscriptionParamsSchema: z$1.ZodObject<{
  /** HTTPS URL to receive webhook events. */webhookUrl: z$1.ZodString; /** Event types to subscribe to. Defaults to trigger messages. */
  enabledEvents: z$1.ZodOptional<z$1.ZodArray<z$1.ZodString, "many">>; /** Webhook payload version. Defaults to V3. */
  version: z$1.ZodOptional<z$1.ZodEnum<["V1", "V2", "V3"]>>;
}, "strip", z$1.ZodTypeAny, {
  webhookUrl: string;
...
type SetWebhookSubscriptionParams = z$1.infer<typeof SetWebhookSubscriptionParamsSchema>;
...
declare const VerifyWebhookParamsSchema: z$1.ZodObject<{
   ...
   * Format: 'msg_xxx'
   */
  id: z$1.ZodString; /** The raw webhook payload as a string (request body) */
  payload: z$1.ZodString; /** The webhook secret used to sign the payload (from Composio dashboard) */
