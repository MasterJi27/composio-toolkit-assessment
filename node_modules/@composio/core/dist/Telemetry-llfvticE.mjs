import { l as ComposioError$1, u as logger, y as getEnvVariable } from "./SsrfErrors-BQRozkeU.mjs";
import { c as getRandomUUID } from "./sensitiveFileUploadPaths-B1OLsd8F.mjs";
...
const REDACTION_RULES = [
	...
	[/\b(authorization|api[-_]?key|apikey|x-api-key|access[-_]?token|refresh[-_]?token|client[-_]?secret|secret|password|passwd|pwd)\b(\s*[:=]+\s*)(["']?)([^\s"',}&]+)\3/gi, `$1$2$3${REDACTED}$3`]
];
/**
