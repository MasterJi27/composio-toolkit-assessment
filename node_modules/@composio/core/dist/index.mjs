import { _ as USER_DATA_FILE_NAME, a as ComposioFileUploadError, b as getEnvsWithPrefix, c as FileModifierErrorCodes, d as COMPOSIO_DIR, f as COMPOSIO_LOG_LEVEL, g as TEMP_FILES_DIRECTORY_NAME, h as IS_DEVELOPMENT_OR_CI, i as ComposioFileUploadAbortedError, l as ComposioError, m as DEFAULT_TOOL_ROUTER_SESSION_FILES_MOUNT_ID, n as SsrfErrorCodes, o as ComposioFileUploadPathNotAllowedError, p as DEFAULT_BASE_URL, r as ComposioFileNotFoundError, s as ComposioSensitiveFilePathBlockedError, t as ComposioBlockedInternalUrlError, u as logger, v as constants_exports, y as getEnvVariable } from "./SsrfErrors-BQRozkeU.mjs";
import { A as ToolErrorCodes, B as ComposioSharedAccessDeniedError, C as ComposioInvalidExecuteFunctionError, D as ComposioToolExecutionError, E as ComposioProviderNotDefinedError, F as ComposioAclOnlyForSharedError, H as ConnectedAccountErrorCodes, I as ComposioConnectedAccountNotFoundError, L as ComposioFailedToCreateConnectedAccountLink, M as ConnectionRequestErrorCodes, N as ConnectionRequestFailedError, O as ComposioToolNotFoundError, P as ConnectionRequestTimeoutError, R as ComposioLegacyConnectedAccountsEndpointRetiredError, S as ComposioGlobalExecuteToolFnNotSetError, T as ComposioInvalidToolArgumentsError, U as AuthConfigErrorCodes, V as ComposioSharedConnectionNotAccessibleError, W as ComposioAuthConfigNotFoundError, _ as ValidationError, a as ComposioFailedToSubscribeToPusherChannelError, b as ComposioToolkitNotFoundError, c as ComposioWebhookPayloadError, d as ComposioNoAPIKeyError, f as ComposioRequestCancelledError, g as JsonSchemaToZodError, h as JsonSchemaRefResolutionError, i as ComposioFailedToGetSDKRealtimeCredentialsError, j as handleToolExecutionError, k as ComposioToolVersionRequiredError, l as ComposioWebhookSignatureVerificationError, m as isRequestAbortError, n as RemoteFileErrorCodes, o as ComposioFailedToUnsubscribeFromPusherChannelError, p as SDKErrorCodes, r as ComposioFailedToCreatePusherClientError, s as ComposioTriggerTypeNotFoundError, t as RemoteFileDownloadError, u as TriggerErrorCodes, v as ValidationErrorCodes, w as ComposioInvalidModifierError, x as ToolkitErrorCodes, y as ComposioToolkitFetchError, z as ComposioMultipleConnectedAccountsError } from "./errors-B165yJUQ.mjs";
import { r as schemaHasFileUploadable, t as isPlainObject } from "./FileToolModifier.utils.neutral-B5rT711M.mjs";
import { a as removeNonRequiredProperties, i as jsonSchemaToZodSchema, n as deduplicateJsonSchemaRequiredArrays, r as dereferenceJsonSchema, t as withCancellation } from "./cancellation-W65QRyj2.mjs";
import { t as telemetry } from "./Telemetry-llfvticE.mjs";
import { i as arrayBufferToBase64, n as assertSafeFileUploadPath, r as isBlockedSensitiveFileUploadPath, s as getRandomShortId, t as BUILTIN_FILE_UPLOAD_PATH_DENY_SEGMENTS } from "./sensitiveFileUploadPaths-B1OLsd8F.mjs";
import { a as createCustomToolkit, c as getPreloadedCustomToolSlugs, d as CreateCustomToolBaseSchema, f as CreateCustomToolkitBaseSchema, i as createCustomTool, l as serializeCustomToolkits, n as buildCustomToolsMap, o as findCustomToolMapEntryByFinalSlug, p as CustomToolSlugSchema, r as buildCustomToolsMapFromResponse, s as findCustomToolMapEntryByToolkitAndOriginalSlug, t as assertNoCustomToolSlugsInPreload, u as serializeCustomTools } from "./CustomTool-C_5NvBsX.mjs";
...
const AuthConfigListParamsSchema = z$1.object({
	...
	showDisabled: z$1.boolean().optional(),
...
const Oauth2RevokedConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
	status: z$1.literal(ConnectionStatuses.REVOKED),
	revoked_at: z$1.string().optional()
}).catchall(z$1.unknown());
...
const ParametersSchema = z$1.preprocess(deduplicateJsonSchemaRequiredArrays, z$1.object({
...
*/
const normalizeToolkitSlug = (toolkitSlug) => toolkitSlug.toLowerCase();
/**
...
const getToolkitVersion = (toolkitSlug, toolkitVersions) => {
	...
	if (toolkitVersions && Object.keys(toolkitVersions).length > 0) return toolkitVersions[normalizeToolkitSlug(toolkitSlug)] ?? "latest";
	return "latest";
};
...
var Tools = class {
	...
	*/
	get clientWithoutRetries() {
		if (!this.clientWithoutRetriesCache) this.clientWithoutRetriesCache = this.client.withOptions({ maxRetries: 0 });
	...
	*/
	async executeComposioTool(tool, body, requestOptions) {
		...
		try {
			...
			const result = await withCancellation(() => this.clientWithoutRetries.tools.execute(tool.slug, executeBody, requestOptions), requestOptions?.signal);
	...
	*/
	async proxyExecute(body, requestOptions) {
		...
		return withCancellation(() => this.clientWithoutRetries.tools.proxy(proxyBody, requestOptions), requestOptions?.signal);
	}
};
...
const ConnectedAccountTypeSchema = z$1.enum([ConnectedAccountTypes.PRIVATE, ConnectedAccountTypes.SHARED]);
/**
...
const aclUserIdString = z$1.string().min(1).max(256);
const ConnectedAccountAclConfigSchema = z$1.object({
	allowAllUsers: z$1.boolean().optional().describe("When true, any `userId` may use this SHARED connection (subject to the deny list). Default false."),
	allowedUserIds: z$1.array(aclUserIdString).max(ACL_LIST_MAX_LENGTH).optional().describe("Explicit list of `userId` strings allowed to use this SHARED connection. Default []."),
	notAllowedUserIds: z$1.array(aclUserIdString).max(ACL_LIST_MAX_LENGTH).optional().describe("Explicit list of `userId` strings denied access. Wins over allow on conflict. Default [].")
});
/**
...
*/
const ConnectedAccountAclConfigResponseSchema = z$1.object({
	allowAllUsers: z$1.boolean(),
	allowedUserIds: z$1.array(z$1.string()),
	notAllowedUserIds: z$1.array(z$1.string())
});
/**
...
*/
const ConnectedAccountExperimentalSchema = z$1.object({
...
*/
const ConnectedAccountExperimentalResponseSchema = z$1.object({
	accountType: ConnectedAccountTypeSchema.optional(),
...
const ConnectedAccountRetrieveResponseSchema = z$1.object({
	...
	wordId: z$1.string().nullable().optional(),
	alias: z$1.string().nullable().optional(),
	/**
...
const CreateConnectedAccountLinkOptionsSchema = z$1.object({
	/**
...
const UpdateConnectedAccountParamsSchema = z$1.object({ enabled: z$1.boolean() });
/**
...
const WebhookPayloadV3Schema = z$1.object({
	id: z$1.string(),
	timestamp: z$1.string(),
	type: z$1.string().refine((val) => val.startsWith("composio."), { message: "V3 event type must start with 'composio.'" }),
	metadata: z$1.record(z$1.unknown()),
	data: z$1.record(z$1.unknown())
});
/** V3 trigger-specific payload - has trigger metadata fields */
const WebhookTriggerPayloadV3Schema = z$1.object({
	id: z$1.string(),
	timestamp: z$1.string(),
	type: z$1.string(),
	metadata: z$1.object({
...
const SetWebhookSubscriptionParamsSchema = z$1.object({
	/** HTTPS URL to receive webhook events. */
	webhookUrl: z$1.string().min(1),
	/** Event types to subscribe to. Defaults to trigger messages. */
	enabledEvents: z$1.array(z$1.string()).min(1).optional(),
...
const firstWebhookSubscriptionId = (response) => {
	const firstItem = Array.isArray(response.items) ? response.items[0] : void 0;
...
var Triggers = class {
	...
	*/
	async setWebhookSubscription(params) {
		...
		const existing = await this.client.get(WEBHOOK_SUBSCRIPTIONS_PATH, { query: { limit: 1 } });
		const subscriptionId = firstWebhookSubscriptionId(existing);
		const subscription = subscriptionId ? await this.client.patch(`${WEBHOOK_SUBSCRIPTIONS_PATH}/${encodeURIComponent(subscriptionId)}`, { body }) : await this.client.post(WEBHOOK_SUBSCRIPTIONS_PATH, { body });
	...
	*/
	async create(userId, slug, body, requestOptions) {
		if (!userId?.trim()) throw new ValidationError(`A non-empty userId is required to create a trigger`);
...
function getToolkitVersionsFromEnv(defaultVersions) {
	...
	const toolkitVersionsFromEnv = Object.entries(envPrefixedVersions).reduce((acc, [key, value]) => {
		...
		acc[normalizeToolkitSlug(toolkitName)] = value;
		return acc;
	}, {});
	let userProvidedToolkitVersions = {};
	if (defaultVersions && typeof defaultVersions === "object") userProvidedToolkitVersions = Object.fromEntries(Object.entries(defaultVersions).map(([key, value]) => [normalizeToolkitSlug(key), value]));
...
*/
const SandboxSizeSchema = z.enum([
	"standard",
	"medium",
	"large",
	"xlarge"
]);
const ToolRouterSandboxConfigSchema = z.object({
	enable: z.boolean().default(true).describe("Whether to enable the sandbox entirely. Defaults to true. When set to false, no code execution tools (COMPOSIO_REMOTE_WORKBENCH, COMPOSIO_REMOTE_BASH_TOOL) are available in the session."),
	enableProxyExecution: z.boolean().optional().describe("Whether to enable proxy execution in the session sandbox"),
	autoOffloadThreshold: z.number().optional().describe("The auto offload threshold in characters for tool execution to move into the sandbox"),
...
const ToolRouterCreateSessionConfigBaseSchema = z.object({
	sessionPreset: z.literal(SessionPreset.DIRECT_TOOLS).optional().describe("Shortcut to expose every tool allowed by the session filters directly in session.tools() and the MCP tool list. This disables meta tools by default (search, multi-execute, manage-connections, and workbench). Use when all tools are known upfront and helper/meta tools are not needed. Without this preset, ToolRouter uses its default configuration with meta tools enabled."),
	mcp: z.boolean().optional().describe("When true, the returned session surfaces its hosted MCP endpoint (`session.mcp.url` / `session.mcp.headers`) in the type. The endpoint exists on every session at runtime regardless of this flag, but is only typed when `mcp: true` is passed. Default native tools (`session.tools()`) are unaffected. See https://docs.composio.dev/docs/sessions-via-mcp"),
	...
	connectedAccounts: z.record(z.string(), z.union([z.string(), z.array(z.string())])).describe("The connected accounts to use in the tool router session. The key is the toolkit slug, the value is a connected account id or an array of ids. Only one account per toolkit is allowed when multi-account mode is disabled.").default({}),
	...
	multiAccount: z.object({
		enable: z.boolean().default(false).describe("When true, enables multi-account mode for this session. Defaults to false."),
		maxAccountsPerToolkit: z.number().int().min(2).max(10).optional().describe("Maximum number of connected accounts allowed per toolkit. Defaults to 5 when multi-account is enabled."),
		requireExplicitSelection: z.boolean().optional().describe("When true, require explicit account selection when multiple accounts are connected. When false (default), use the first/default account.")
	}).optional().describe("Multi-account configuration for this session"),
	preload: z.object({ tools: z.union([z.array(z.string()), z.literal("all")]).optional().describe("Tool slugs to preload into session.tools() and the MCP tool list, or \"all\" to preload every app tool allowed by the session filters. \"all\" requires a positive filter such as toolkits, tools, or tags; the backend validates and caps the final tool set.") }).strict().optional().describe("Preload configuration for tools that should be exposed without search."),
	experimental: z.object({
		assistivePrompt: z.object({ userTimezone: z.string().optional().describe("IANA timezone identifier (e.g., \"America/New_York\", \"Europe/London\") for timezone-aware assistive prompts") }).optional().describe("Configuration for assistive prompt generation"),
		customTools: z.array(z.custom()).optional().describe("Custom tools to include in this session. Created via createCustomTool() from @composio/core/experimental."),
		customToolkits: z.array(z.custom()).optional().describe("Custom toolkits to include in this session. Created via createCustomToolkit() from @composio/core/experimental.")
...
const ToolRouterCreateSessionConfigSchema = z.preprocess(applyDirectToolsPresetDefaults, ToolRouterCreateSessionConfigBaseSchema).describe("The config for the tool router session");
...
const ToolRouterSessionSearchResultSchema = z.object({
	...
	referenceWorkbenchSnippets: z.array(ToolRouterSessionSearchResultReferenceWorkbenchSnippetSchema).optional()
});
...
const ToolRouterSessionSearchResponseSchema = z.object({
	success: z.boolean(),
...
const ToolRouterSessionExecuteResponseSchema = z.object({
	data: z.record(z.string(), z.unknown()),
	error: z.string().nullable(),
	logId: z.string()
});
const SessionProxyExecuteParamsSchema = z.object({
...
const ToolRouterUpdateSessionConfigSchema = z.object({
	toolkits: z.union([
		ToolRouterToolkitsParamSchema,
		ToolRouterToolkitsDisabledConfigSchema,
		ToolRouterToolkitsEnabledConfigSchema
	]).optional(),
	tools: z.record(z.string(), z.union([ToolRouterToolsParamSchema, ToolRouterConfigToolsSchema])).optional(),
	tags: ToolRouterConfigTagsSchema.optional(),
	authConfigs: z.record(z.string(), z.string()).optional(),
	connectedAccounts: z.record(z.string(), z.union([z.string(), z.array(z.string())])).transform((rec) => {
		const out = {};
		for (const [k, v] of Object.entries(rec)) out[k] = typeof v === "string" ? [v] : v;
		return out;
	}).optional(),
	manageConnections: z.union([z.boolean(), ToolRouterConfigManageConnectionsSchema]).nullable().optional(),
	...
	preload: z.object({ tools: z.union([z.array(z.string()), z.literal("all")]).optional() }).strict().optional()
}).partial().superRefine((config, ctx) => {
	if (config.sandbox !== void 0 && config.workbench !== void 0) ctx.addIssue({
		code: z.ZodIssueCode.custom,
		message: "Pass either sandbox or workbench, not both. workbench is a backwards-compatible alias for sandbox.",
...
const ToolRouterSessionDeleteResponseSchema = z.object({
	sessionId: z.string(),
...
const ToolRouterSessionFilesMountListOptionsSchema = z.object({
...
const ToolRouterSessionFilesMountUploadOptionsSchema = z.object({
...
const ToolRouterSessionFilesMountDownloadOptionsSchema = z.object({ mountId: z.string().default(DEFAULT_TOOL_ROUTER_SESSION_FILES_MOUNT_ID) });
const ToolRouterSessionFilesMountDeleteOptionsSchema = z.object({ mountId: z.string().default(DEFAULT_TOOL_ROUTER_SESSION_FILES_MOUNT_ID) });
...
*/
const AuthorizeOptionsSchema = z$1.object({
	callbackUrl: z$1.string().optional(),
	alias: z$1.string().optional(),
	experimental: ConnectedAccountExperimentalSchema.optional()
});
...
var ToolRouterSession = class {
	...
	*/
	async routeMultiExecute(input, ToolsModel, tools, modifiers) {
		...
		const [localResults, remoteOutcome] = await Promise.all([Promise.all(localPromises), remotePromise ? remotePromise.then((result) => ({ result })).catch((error) => ({ error })) : void 0]);
		...
		const remoteErrorMessage = remoteTransportFailed ? (remoteTransportError instanceof Error ? remoteTransportError.message : String(remoteTransportError)) || "Remote tool execution failed" : null;
		const remoteResult = remoteOutcome && "result" in remoteOutcome ? remoteOutcome.result : void 0;
		...
		const remoteResults = remoteErrorMessage ? remoteIndices.map((index) => ({
			response: {
				successful: false,
				data: {},
		...
		const allResults = [...remoteResults.map((entry, remotePosition) => ({
			...entry,
			index: remoteIndices[remotePosition] ?? remotePosition
		})), ...localEntries].sort((a, b) => Number(a.index) - Number(b.index)).map((entry, i) => ({
			...entry,
			index: i
		}));
		...
		if (localEntries.length > 0 && (remoteErrorMessage || [
			"total_count",
			"success_count",
			"error_count"
		...
		const remoteError = remoteErrorMessage ?? (typeof remoteResult?.error === "string" ? remoteResult.error : null);
...
*/
const WebhookConnectedAccountAuthConfigSchema = z$1.object({
	/** The nano ID of the auth config */
	id: z$1.string(),
	/** @deprecated - use state.authScheme instead */
	auth_scheme: z$1.nativeEnum(AuthSchemeTypes),
	/** Whether this auth config is managed by Composio */
	is_composio_managed: z$1.boolean(),
	/** Whether the auth config is disabled */
	is_disabled: z$1.boolean(),
	/** @deprecated */
	deprecated: z$1.object({ uuid: z$1.string() }).optional()
}).passthrough();
/**
...
*/
const WebhookConnectionStateSchema = z$1.object({
	/** The auth scheme type (e.g., 'OAUTH2', 'API_KEY') */
	authScheme: z$1.nativeEnum(AuthSchemeTypes),
	/** Connection state values - varies by auth scheme */
	val: z$1.record(z$1.unknown())
}).passthrough();
/**
...
*/
const SingleConnectedAccountDetailedResponseSchema = z$1.object({
	/** Toolkit information */
	toolkit: z$1.object({ slug: z$1.string().describe("The slug of the toolkit") }).passthrough(),
	/** Auth config details */
	...
	user_id: z$1.string(),
	/** Connection status */
	status: z$1.nativeEnum(ConnectionStatuses),
	...
	data: z$1.record(z$1.unknown()),
	/** @deprecated - use state instead */
	params: z$1.record(z$1.unknown()),
	/** Reason for the current status (e.g., expiration reason) */
	status_reason: z$1.string().nullable(),
	/** Whether the connection is disabled */
	is_disabled: z$1.boolean(),
	/** Endpoint for making test requests */
	test_request_endpoint: z$1.string().optional(),
	/** @deprecated */
	deprecated: z$1.object({
		labels: z$1.array(z$1.string()),
		uuid: z$1.string()
	}).optional()
}).passthrough();
/**
...
* Uses .passthrough() to accept unknown fields the API may add in the future.
*/
const WebhookConnectionMetadataSchema = z$1.object({
	/** Project nano ID */
...
* ```
*/
const ConnectionExpiredEventSchema = z$1.object({
	/** Unique message ID (e.g., "msg_847cdfcd-d219-4f18-a6dd-91acd42ca94a") */
	id: z$1.string(),
	/** ISO-8601 timestamp of when the event was emitted */
	timestamp: z$1.string(),
	/** Event type identifier */
	type: z$1.literal(WebhookEventTypes.CONNECTION_EXPIRED),
...
*/
const WebhookEventSchema = z$1.discriminatedUnion("type", [ConnectionExpiredEventSchema]);
