import { a as ComposioFileUploadError, i as ComposioFileUploadAbortedError, o as ComposioFileUploadPathNotAllowedError, r as ComposioFileNotFoundError, s as ComposioSensitiveFilePathBlockedError, u as logger } from "../../SsrfErrors-BQRozkeU.mjs";
import { f as ComposioRequestCancelledError } from "../../errors-B165yJUQ.mjs";
...
import { r as dereferenceJsonSchema, t as withCancellation } from "../../cancellation-W65QRyj2.mjs";
import { n as getFileDataAfterUploadingToS3, r as isHttpUrl, t as downloadFileFromS3 } from "../../fileUtils.node-iPFi2o4i.mjs";
...
const hydrateFiles = async (value, schema, ctx) => {
	if (schema?.file_uploadable) {
		...
		if (typeof value === "string") {
			const pathOrUrl = await runBeforeFileUpload(value, isHttpUrl(value) ? "url" : "path");
