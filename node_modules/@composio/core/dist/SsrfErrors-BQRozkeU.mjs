...
//#endregion
//#region src/errors/SsrfErrors.ts
const SsrfErrorCodes = { BLOCKED_INTERNAL_URL: "BLOCKED_INTERNAL_URL" };
/**
...
*/
var ComposioBlockedInternalUrlError = class extends ComposioError$1 {
	constructor(message = "Refusing to fetch an internal or non-public URL", options = {}) {
...
//#endregion
export { USER_DATA_FILE_NAME as _, ComposioFileUploadError as a, getEnvsWithPrefix as b, FileModifierErrorCodes as c, COMPOSIO_DIR as d, COMPOSIO_LOG_LEVEL as f, TEMP_FILES_DIRECTORY_NAME as g, IS_DEVELOPMENT_OR_CI as h, ComposioFileUploadAbortedError as i, ComposioError$1 as l, DEFAULT_TOOL_ROUTER_SESSION_FILES_MOUNT_ID as m, SsrfErrorCodes as n, ComposioFileUploadPathNotAllowedError as o, DEFAULT_BASE_URL as p, ComposioFileNotFoundError as r, ComposioSensitiveFilePathBlockedError as s, ComposioBlockedInternalUrlError as t, logger as u, constants_exports as v, getEnvVariable as y };