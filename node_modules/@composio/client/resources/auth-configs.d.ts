...
export declare namespace AuthConfigCreateParams {
    ...
    namespace UnionMember0 {
        interface Credentials {
            ...
            /**
             * OAuth user-token scopes requested for the managed auth config. This is primarily
             * used by Slack OAuth v2.
             */
    ...
    namespace UnionMember1 {
        interface Credentials {
            ...
            scopes?: string | Array<string>;
            /**
             * OAuth user-token scopes requested for the custom auth config. This is primarily
             * used by Slack OAuth v2.
             */
            user_scopes?: string | Array<string>;
        }
...
export declare namespace AuthConfigUpdateParams {
    ...
    namespace Variant0 {
        interface Credentials {
            ...
            scopes?: string | Array<string>;
            /**
             * OAuth user-token scopes requested for the auth config. This is primarily used by
             * Slack OAuth v2.
             */
            user_scopes?: string | Array<string>;
        }
