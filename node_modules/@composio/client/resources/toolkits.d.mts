...
export declare namespace ToolkitRetrieveResponse {
    ...
    namespace AuthConfigDetail {
         ...
         * recommend using this field for authentication and might break post Aug 31 2025.
         */
        interface DeprecatedAuthProviderDetails {
...
export declare namespace Toolkits {
    export { type ToolkitRetrieveResponse as ToolkitRetrieveResponse, type ToolkitListResponse as ToolkitListResponse, type ToolkitRetrieveCategoriesResponse as ToolkitRetrieveCategoriesResponse, type ToolkitRetrieveParams as ToolkitRetrieveParams, type ToolkitListParams as ToolkitListParams, };
}
